...
$updatephoto = "UPDATE profile SET photo = '$uploadpath$ThumbPrefix$NewImageName'  WHERE firstname  = '$surname'";

mysql_query($updatephoto,$connectionstring);	




// update photo on mongodb database
...
";
  ...
  try{
    ...
    array('$set' => array("photo" => $uploadpath.$ThumbPrefix.$NewImageName)));
