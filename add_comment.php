...
$resquery = mysql_query($checklogin2,$connectionstring);
	...
	if(checkValues($_REQUEST['comment_text']) && $_REQUEST['post_id'])
	{
		...
		mysql_query("INSERT INTO facebook_posts_comments (post_id,comments,userip,date_created) VALUES('".$_REQUEST['post_id']."','".checkValues($_REQUEST['comment_text'])."','".$surname."','".strtotime(date("Y-m-d H:i:s"))."')");
